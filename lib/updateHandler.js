...
UpdateHandler.prototype.process = function(data, options, callback) {
	...
	options.fields.forEach(function(path) {
    	...
    	var noedit_permissions = field.options.noedit_permissions || [];
    	if (noedit_permissions.indexOf(user_permission) != -1){
        	return;
    	}
    	var hidden_permissions = field.options.hidden_permissions || [];
    	if (hidden_permissions.indexOf(user_permission) != -1){
        	return;
    	}
