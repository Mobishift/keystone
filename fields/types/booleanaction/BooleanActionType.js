...
/**
 * BooleanAction FieldType Constructor
 * @extends Field
 * @api public
 */
function booleanaction(list, path, options) {
	this._nativeType = Boolean;
	this._properties = ['indent'];
	this._fixedSize = 'full';
	this.indent = (options.indent) ? true : false;
	booleanaction.super_.call(this, list, path, options);
}
util.inherits(booleanaction, FieldType);

/**
 * Add filters to a query
 */
booleanaction.prototype.addFilterToQuery = function(filter, query) {
	query = query || {};
 ...
 */
booleanaction.prototype.inputIsValid = function(data, required) {
	if (required) {
 ...
 */
booleanaction.prototype.updateItem = function(item, data) {
